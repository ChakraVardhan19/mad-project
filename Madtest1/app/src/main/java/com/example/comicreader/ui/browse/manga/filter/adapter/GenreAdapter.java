package com.example.comicreader.ui.browse.manga.filter.adapter;
...
public class GenreAdapter extends RecyclerView.Adapter<GenreAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (genre.equals(selectedGenre)) {
            holder.genre.setTextColor(ThemeHelper.resolveColorAttr(holder.genre.getContext(), androidx.appcompat.R.attr.colorPrimary));
            holder.genre.getCompoundDrawablesRelative()[0].setTint(ThemeHelper.resolveColorAttr(holder.genre.getContext(), androidx.appcompat.R.attr.colorPrimary));
        }
